...
module.exports = {
  ...
  // when NxAppWebpackPlugin changes the output name to 'seed'.
  entry: {
    seed: join(__dirname, 'src/seed/seed.ts'),
  },
  resolve: {
    alias: {
  ...
  output: {
    ...
    // Do not clean — main.js/worker.js (built by other targets) must survive
    clean: false,
